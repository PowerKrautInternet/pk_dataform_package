...
${pk.ifSource("sam_offerte_vtr", `IFNULL(OFFERTE.OFFERTEVTR_TRANSACTIERESULTAAT, LAST_OFFERTE.OFFERTEVTR_TRANSACTIERESULTAAT) as offerte_OFFERTEVTR_TRANSACTIERESULTAAT,
...
${pk.ifSource("sam_trajects_extern", `TRAJECTEXTERN_EXTERNGUID as offerte_LEADTRAJECT_EXTERNLEADID,`)}
LEADTRAJECT.TRAJECT_EERSTEKWALIFICATIE as offerte_LEADTRAJECT_EERSTEKWALIFICATIE,
${pk.ifSource("sam_trajects_extern", `TRAJECTEXTERN_SOORTLEADSBRONID as offerte_LEADTRAJECT_SOORTLEADSBRONID,`)}
${pk.ifSource("sam_herkomst", `HERKOMST_OMSCHRIJVING as offerte_HERKOMST_OMSCHRIJVING,`)}
...
${pk.join("LEFT JOIN", "sam_trajects_extern", "TRAJECTEXTERN ON LEADTRAJECT.TRAJECT_TRAJECTID = TRAJECTEXTERN_TRAJECTID AND LEADTRAJECT.TRAJECT_DTCMEDIA_CRM_ID = TRAJECTEXTERN_DTCMEDIA_CRM_ID")}

${pk.join("LEFT JOIN", "sam_herkomst", "HERKOMST ON SALESTRAJECT.TRAJECT_HERKOMSTID = HERKOMST.HERKOMST_HERKOMSTID AND SALESTRAJECT.TRAJECT_DTCMEDIA_CRM_ID = HERKOMST.HERKOMST_DTCMEDIA_CRM_ID")}
