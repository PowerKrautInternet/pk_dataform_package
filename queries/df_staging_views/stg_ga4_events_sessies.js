...
FROM(
    ...
    * EXCEPT(session_default_channel_group),
    ...
    CONCAT(IFNULL(event_buy_brand, ""), IFNULL(event_buy_model, ""), ${ifSource("ga4_items", "IFNULL(item_brand, ''),")} IFNULL(event_name, ""), IFNULL(event_page_title, ""), IFNULL(event_page_location, ""), IFNULL(event_page_referrer, "")) as event_merk_concat,
