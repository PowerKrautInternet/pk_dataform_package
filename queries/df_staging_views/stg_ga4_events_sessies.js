...
FROM(
    ...
    * EXCEPT(session_default_channel_group),
    ...
    CONCAT(IFNULL(event_buy_brand, ""), IFNULL(event_buy_model, ""), ${ifSource("ga4_items", "IFNULL(item_brand, ''), IFNULL(item_variant, ''),")} IFNULL(event_name, ""), IFNULL(event_page_title, ""), IFNULL(event_page_location, ""), IFNULL(event_page_referrer, "")) as event_merk_concat,
    CONCAT(IFNULL(session_google_ads_ad_group_name, ""), IFNULL(session_campaign, ""), IFNULL(session_landingpage_title, ""), IFNULL(session_landingpage_location, ""), IFNULL(session_term, ""), IFNULL(session_content, "")) as session_merk_concat,
