...
ga4_ads AS (
  SELECT
    ...
    ${ifNull([`IF(kanaal IN ('META', 'Microsoft Ads'), ga4.session_content, ga4.session_google_ads_ad_group_name)`, ifSource("stg_marketingkanalen_combined", "marketing_kanalen.ad_group_name")], "AS ad_group_name,")}
