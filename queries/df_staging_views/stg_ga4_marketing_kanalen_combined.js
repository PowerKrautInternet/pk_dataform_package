...
${join("LEFT JOIN", "gs_campagnegroepen", "AS groep ON LOWER(campaign_name) LIKE LOWER(CONCAT(\"%\", groep.campagnegroep, \"%\")) OR LOWER(lef_kwalificatie) LIKE LOWER(CONCAT(\"%\", groep.campagnegroep, \"%\"))")})
