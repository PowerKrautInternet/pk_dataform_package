...
SELECT
    ...
    ${ifSource("stg_marketingkanalen_combined", "marketing_kanalen.* EXCEPT(bron, campaign_name, record_date, campaign_id, ad_group_id, ad_group_name, merk, event_page_location),")}
    ${ifNull([
        "ga4.bron",
