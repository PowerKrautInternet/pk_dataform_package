...
let query = `
SELECT
* ${orSource(["stg_handmatige_uitgaves_pivot", "gs_kostenlefmapping", "gs_kostensyntecmapping"], "EXCEPT(campagnegroep), IFNULL(campagnegroep, uitgave_categorie) AS campagnegroep")}
FROM(
...
SELECT
    ...
    ${ifNull([ifSource("stg_handmatige_uitgaves_pivot", "marketing_kanalen.bron"), ifSource("gs_kostenlefmapping","lef.kanaal"), ifSource("gs_kostensyntecmapping", "syntec.kanaal")], "AS uitgave_bron,")}
