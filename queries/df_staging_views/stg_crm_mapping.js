...
lef_enriched AS (
  SELECT
    ...
    ${ifNull([ifSource('stg_sam_offertes_orders', 'lef.sam_model'), 'lef.lef_gewenst_model'])} AS gewenst_model,
    ${ifNull([ifSource('stg_sam_offertes_orders', 'lef.sam_soort_auto'), 'lef.lef_gewenst_autosoort'])} AS gewenst_autosoort,
