...
FROM (
   ...
   FROM(
    SELECT
        ...
        ${ifSource("stg_adpaq_pk", "adpaq.creative_name AS adpaq_creative_name,")}
        ${ifSource("stg_adpaq_pk", "adpaq.publisher_name AS adpaq_publisher_name,")}
        ${ifSource("stg_adpaq_pk", "adpaq.station AS adpaq_station,")}
        ${ifSource("stg_adpaq_pk", "adpaq.deal_id AS adpaq_deal_id,")}
        ${ifSource("stg_adpaq_pk", "adpaq.agency_name AS adpaq_agency_name,")}
        ${ifSource("stg_adpaq_pk", "adpaq.ssp_name AS adpaq_ssp_name,")}
        ${ifSource("stg_adpaq_pk", "adpaq.tech_fees AS adpaq_tech_fees,")}
        ${ifSource("stg_adpaq_pk", "adpaq.agency_fees AS adpaq_agency_fees,")}
        ${ifSource("stg_adpaq_pk", "adpaq.budget_spent AS adpaq_budget_spent,")}
    FROM
    ...
    ${join("full outer join", "df_staging_views", "stg_adpaq_pk", "AS adpaq ON 1=0")}
