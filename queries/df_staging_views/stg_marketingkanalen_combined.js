...
FROM (
    SELECT
        ...
        ${ifNull(['google_ads.Cost', ifSource('stg_facebookdata','facebook.spend'), ifSource('dv360_data','dv360.revenue_advertiser_currency'), ifSource('stg_bing_ad_group_performance','microsoft.spend'), ifSource('stg_linkedin_ads_combined','linkedin.cost'), , ifSource('handmatige_uitgaves_pivot', 'handmatig.uitgaven')])} as ads_cost,
