...
FROM (
   ...
   FROM(
    SELECT
        ...
        ${ifNull(['CAST(google_ads.campaign_id AS STRING)', ifSource('stg_facebookdata','facebook.campaign_id'), ifSource('dv360_data','CAST(dv360.campaign_id AS STRING)'), ifSource('stg_bing_ad_group_performance','microsoft.campaign_id'), ifSource('stg_linkedin_ads_combined','linkedin.campaign_id'), ifSource('stg_vistar_media_ads','vistar_media.insertion_order'), ifSource('stg_adpaq','adpaq.campaign_id')])} as campaign_id,
        ${ifNull(['google_ads.campaign_name', ifSource('stg_facebookdata','facebook.campaign_name'), ifSource('dv360_data','dv360.campaign'), ifSource('stg_bing_ad_group_performance','microsoft.campaign_name'), ifSource('stg_linkedin_ads_combined','linkedin.campaign_group_name'), ifSource('stg_vistar_media_ads','vistar_media.insertion_order_name'), ifSource('stg_adpaq','adpaq.campaign_name')])} as campaign_name,
        ...
        ${ifNull(['google_ads.ad_group_name', ifSource('stg_facebookdata','facebook.adset_name'), ifSource('dv360_data','dv360.insertion_order'), ifSource('stg_bing_ad_group_performance','microsoft.adgroup_name'), ifSource('stg_linkedin_ads_combined','linkedin.campaign_name'), ifSource('stg_vistar_media_ads','vistar_media.campaign_name'), ifSource('stg_adpaq','adpaq.line_item_name')])} as ad_group_name,
        ...
        ${ifSource("dv360_data", "dv360.line_item AS dv360_line_item,")}
        ...
        ${ifSource("dv360_data", "dv360.dv360_inventory_source AS dv360_inventory_source,")}
