...
SELECT
  ...
  SAFE_CAST(offerte_SALESTRAJECT_AFGERONDDATUM AS DATE) AS offerte_SALESTRAJECT_AFGERONDDATUM,
  SAFE_CAST(offerte_SALESTRAJECT_CREATIEDATUM AS DATE) AS offerte_SALESTRAJECT_CREATIEDATUM,
  CASE
