...
SELECT
  ...
  initials AS initials_otm,
  first_name AS first_name_otm,
  infix AS infix_otm,
  last_name AS last_name_otm,
  phone AS phone_otm,
  postal_code AS postal_code_otm,
  house_number AS house_number_otm,
  house_number_addition AS house_number_addition_otm,
  street AS street_otm,
  city AS city_otm,
  terms AS terms_otm,
  dealer_id AS dealer_id_otm,
  dealer_name AS dealer_name_otm,
  dealer_zipcode AS dealer_zipcode_otm,
  dealer_street AS dealer_street_otm,
  dealer_city AS dealer_city_otm,
  dealer_phone_number AS dealer_phone_number_otm,
  dealer_email AS dealer_email_otm,
