...
SELECT 
  ...
  ${isSource("stg_google_ads_adgroup_conversions") ? "ad_group_conversions.segments_conversion_action_category" : "STRING(NULL) as segments_conversion_action_category"},
