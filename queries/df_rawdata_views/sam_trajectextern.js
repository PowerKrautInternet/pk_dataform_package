...
let query = `
SELECT
        JSON_EXTRACT_SCALAR(PAYLOAD, '$.TRAJECTEXTERNGUID') as TRAJECTEXTERNGUID,
        JSON_EXTRACT_SCALAR(PAYLOAD, '$.TRAJECTID') as TRAJECTEXTERN_TRAJECTID,
        JSON_EXTRACT_SCALAR(PAYLOAD, '$.SOORTLEADSBRONID') as TRAJECTEXTERN_SOORTLEADSBRONID,
        JSON_EXTRACT_SCALAR(PAYLOAD, '$.EXTERNGUID') as TRAJECTEXTERN_EXTERNGUID,
        JSON_EXTRACT_SCALAR(PAYLOAD, '$.DTCMEDIA_CRM_ID') as TRAJECTEXTERN_DTCMEDIA_CRM_ID
FROM (
