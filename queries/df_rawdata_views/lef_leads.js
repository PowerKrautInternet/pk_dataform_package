...
SELECT
    ...
    rawdata.getEmail(JSON_EXTRACT(PAYLOAD, '$.response.klantInfo.contactwijzen')) AS contactwijzen,
    rawdata.getTelefoon(JSON_EXTRACT(PAYLOAD, '$.response.klantInfo.contactwijzen')) AS contactwijzen_Telefoon,
