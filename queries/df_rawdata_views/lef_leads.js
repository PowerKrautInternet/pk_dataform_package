...
SELECT
    ...
    SAFE.PARSE_DATETIME('%Y-%m-%dT%H:%M:%E*S+%H:%M', JSON_VALUE(PAYLOAD, '$.response.overige.aangemaaktDatum')) AS aangemaaktDatum,
    SAFE.PARSE_DATETIME('%Y-%m-%dT%H:%M:%E*S+%H:%M',JSON_VALUE(PAYLOAD, '$.response.overige.eersteDeadlineImporteur')) AS eersteDeadlineImporteur,
    SAFE.PARSE_DATETIME('%Y-%m-%dT%H:%M:%E*S+%H:%M',JSON_VALUE(PAYLOAD, '$.response.overige.eersteDeadline')) AS eersteDeadline,
    SAFE.PARSE_DATETIME('%Y-%m-%dT%H:%M:%E*S+%H:%M',JSON_VALUE(PAYLOAD, '$.response.overige.ingezienDatum')) AS ingezienDatum,
    SAFE.PARSE_DATETIME('%Y-%m-%dT%H:%M:%E*S+%H:%M',JSON_VALUE(PAYLOAD, '$.response.overige.eersteContactpoging')) AS eersteContactpoging,
    ...
    SAFE.PARSE_DATETIME('%Y-%m-%dT%H:%M:%E*S+%H:%M',JSON_VALUE(PAYLOAD, '$.response.overige.afgerondDatum')) AS afgerondDatum,
    ...
    SAFE.PARSE_DATETIME('%Y-%m-%dT%H:%M:%E*S+%H:%M',JSON_VALUE(PAYLOAD, '$.response.overige.laatsteStatus.startGesprek')) AS laatsteStatus_startGesprek,
    SAFE.PARSE_DATETIME('%Y-%m-%dT%H:%M:%E*S+%H:%M',JSON_VALUE(PAYLOAD, '$.response.overige.laatsteStatus.eindGesprek')) AS laatsteStatus_eindGesprek,
