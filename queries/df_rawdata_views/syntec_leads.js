...
let query = `
    ...
    SELECT
        ...
        SAFE.PARSE_DATETIME('%Y-%m-%d %H:%M:%S', NULLIF(json_value(PAYLOAD, '$.response.datum_gesloten'), "")) AS datum_gesloten,
        ...
        SAFE.PARSE_DATETIME('%Y-%m-%d %H:%M:%S', NULLIF(json_value(PAYLOAD, '$.response.laatste_contact'), "")) AS laatste_contact,
        ...
        SAFE.PARSE_DATETIME('%Y-%m-%d %H:%M:%S', NULLIF(json_value(PAYLOAD, '$.response.gemodificeerd'), "")) AS gemodificeerd,
        SAFE.PARSE_DATETIME('%Y-%m-%d %H:%M:%S', NULLIF(json_value(PAYLOAD, '$.response.aangelegd'), "")) AS aangelegd,
