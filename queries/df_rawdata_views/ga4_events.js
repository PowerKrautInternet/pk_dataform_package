...
SELECT
    ...
    (SELECT value.string_value FROM unnest(event_params) WHERE key = 'buy_bouwjaar') as event_buy_bouwjaar,
    ...
    (SELECT value.string_value FROM unnest(event_params) WHERE key = 'trade_in_brandstof') as event_trade_in_brandstof,
