...
SELECT
        ...
        JSON_VALUE(PAYLOAD, '$.NAAM') as VERKOPER_NAAM,
        JSON_VALUE(PAYLOAD, '$.VOORVOEGSEL') as VERKOPER_VOORVOEGSEL,
        JSON_VALUE(PAYLOAD, '$.ACTIEF') as VERKOPER_ACTIEF, 
        JSON_VALUE(PAYLOAD, '$.SOORTGEBRUIKERID') as VERKOPER_SOORTGEBRUIKERID,
