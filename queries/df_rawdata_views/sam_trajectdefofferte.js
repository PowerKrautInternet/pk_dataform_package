...
WHERE JSON_EXTRACT_SCALAR(PAYLOAD, '$.SOORTTRAJECTID') = "2" 
AND JSON_EXTRACT_SCALAR(PAYLOAD, '$.TRAJECTSTATUSID') IN ("1", "2", "3")
AND JSON_EXTRACT_SCALAR(PAYLOAD, '$.DEFINITIEFOFFERTEID') <> ""
