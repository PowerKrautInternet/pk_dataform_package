...
function googleSheetTable (refVal) {
    ...
    return `BEGIN
  CREATE SCHEMA IF NOT EXISTS \`${dataform.projectConfig.defaultDatabase}.df_googlesheets_tables${pk.schemaSuffix(config)}\` OPTIONS(location="${dataform.projectConfig.defaultLocation}");
