...
function lasttransaction (refVal) {
    ...
    return `
        ...
        IF dataform_table_type = 'BASE TABLE' THEN DROP TABLE IF EXISletTS \`${dataform.projectConfig.defaultDatabase + ".df_rawdata_views" + pk.schemaSuffix(refVal) + "." + tableName}_lasttransaction\`;
